  ...
  return (
    <div className="mb-[35px] flex flex-col-reverse justify-between gap-6 md:flex-row">
      ...
      <div className="flex h-[52px] max-w-[458px] flex-row rounded-[100px] bg-[#1c1c24] py-2 pl-4 pr-2 lg:flex-1">
        ...
        />
        <div className="flex h-full w-[72px] cursor-pointer items-center justify-center rounded-[20px] bg-[#008080]">
          <img
            src={search}
            alt="search"
      ...
      <div className="hidden flex-row justify-end gap-2 sm:flex">
        <CustomButton
          ...
          styles={authenticated ? "bg-[#008080]" : "bg-[#008080]"}
          handleClick={handleLoginLogout}
        />
      </div>

      <div className="relative flex items-center justify-between sm:hidden">
        <div className="flex h-[40px] w-[40px] cursor-pointer items-center justify-center rounded-[10px] bg-[#008080]">
          <IconHeartHandshake size={40} color="#fff" className="p-2" />
        </div>
        <img
          src={menu}
          alt="menu"
