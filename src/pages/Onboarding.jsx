...
const Onboarding = () => {
  ...
  const handleOnboarding = async (e) => {
    ...
    try {
      ...
      if (newUser) {
        navigate("/profile"); // Navigate to profile page if user creation is successful
      }
    } catch (error) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#13131a]">
      <div className="w-full max-w-md rounded-xl bg-[#008080] p-8 shadow-lg">
        ...
        <form onSubmit={handleOnboarding}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              max="98" // Ensures age is no more than 98
              className="w-full rounded-lg bg-neutral-900 px-4 py-3 text-neutral-400 focus:border-blue-600 focus:outline-none"
            />
          </div>
