...
const FileUploadModal = ({
  ...
  return (
    ...
    >
      <div className="flex w-full flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-slate-300 p-8 text-slate-700 border-slate-700 text-slate-300">
        <svg
